...
>
	...
	<div class="flex flex-col gap-4 items-center justify-center">
		<div class="flex items-center gap-4 sm:gap-6 text-2xl sm:text-3xl md:text-4xl mx-auto">
			<a href="mailto:suputra.iwn@gmail.com" target="_blank">
				<i class="fa-regular fa-envelope" />
			</a>
			<a href="https://www.linkedin.com/in/nikesuputra/" target="_blank">
				<i class="fa-brands fa-linkedin-in" />
			</a>
			<a href="https://github.com/tigaron/" target="_blank">
